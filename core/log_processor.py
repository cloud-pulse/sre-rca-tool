...
class LogProcessor:
    ...
    def __init__(self):
        ...
        self._re_msg_lead_punct = re.compile(r'^[\s\-]+')
    ...
    def _extract_level(self, line: str) -> str:
        ...
        # Check for aliases
        for alias_lower, regex in self._re_level_aliases:
            if regex.search(line):
    ...
    def _extract_message(self, line: str) -> str:
        ...
        message = self._re_msg_lead_punct.sub('', message)
