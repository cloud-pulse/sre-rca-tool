...
class LogProcessor:
    ...
    def __init__(self):
        ...
        self._level_bracket_pattern = re.compile(r'\[([A-Z]+)\]')
        ...
        self._service_bracket_pattern = re.compile(r'\[([a-z\-]+)\]')
    ...
    def _extract_level(self, line: str) -> str:
        ...
        bracket_match = self._level_bracket_pattern.search(line)
        if bracket_match:
    ...
    def _extract_service(self, line: str) -> str:
        ...
        bracket_match = self._service_bracket_pattern.search(line)
        if bracket_match:
