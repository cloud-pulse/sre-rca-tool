...
class LogProcessor:
    ...
    def __init__(self):
        ...
        self._level_patterns = [
            (valid_level, re.compile(r'\b' + valid_level + r'\b', re.IGNORECASE))
        ...
        # Message extraction removal patterns
        ...
        self._msg_trim_pattern = re.compile(r'^[\s\-]+')
    ...
    def _extract_message(self, line: str) -> str:
        ...
        message = self._msg_trim_pattern.sub('', message)
