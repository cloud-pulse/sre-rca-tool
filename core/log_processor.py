...
class LogProcessor:
    ...
    def _extract_level(self, line: str) -> str:
        ...
        for valid_level, regex in self.re_level_plain:
            if regex.search(line):
                return valid_level

        # Check for aliases
        for alias_lower, regex in self.re_level_alias:
            if regex.search(line):
    ...
    def _extract_service(self, line: str) -> str:
        ...
        for service, regex in self.re_service_plain:
            if regex.search(line):
    ...
    def _extract_message(self, line: str) -> str:
        ...
        for regex in self.re_msg_levels:
            message = regex.sub('', message)

        # Remove service names
        for regex in self.re_msg_services:
            message = regex.sub('', message)
