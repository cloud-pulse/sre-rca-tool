...
class LogProcessor:
    ...
    def __init__(self):
        ...
        # Pre-compile level searches
        self._re_valid_levels = {
            lvl: re.compile(r'\b' + lvl + r'\b', re.IGNORECASE)
    ...
    def _extract_level(self, line: str) -> str:
        ...
        for valid_level, pattern in self._re_valid_levels.items():
            if pattern.search(line):
                return valid_level

        # Check for aliases
        for alias_lower, pattern in self._re_alias_levels.items():
            if pattern.search(line):
    ...
    def _extract_service(self, line: str) -> str:
        ...
        for service, pattern in self._re_services.items():
            if pattern.search(line):
