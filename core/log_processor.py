...
class LogProcessor:
    ...
    def __init__(self):
        ...
        # Reusing compiled regexes avoids overhead on every log line processed
        ...
        self._re_levels = [
            re.compile(r'\b' + level + r'\b', re.IGNORECASE)
        ...
        self._re_services = [
            re.compile(r'\b' + re.escape(service) + r'\b', re.IGNORECASE)
    ...
    def _extract_level(self, line: str) -> str:
        ...
        for i, valid_level in enumerate(self.VALID_LEVELS):
            if self._re_levels[i].search(line):
                return valid_level

        # Check for aliases
        for alias_lower, regex in self._re_aliases.items():
    ...
    def _extract_service(self, line: str) -> str:
        ...
        for i, service in enumerate(self.KNOWN_SERVICES):
            if self._re_services[i].search(line):
